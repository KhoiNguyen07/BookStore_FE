...
const MenuHeader = () => {
  ...
  const HeaderContent = ({className = ""}) => (
    <div className={`w-full mx-auto px-4 sm:px-6 py-4 sm:py-6 ${className}`}>
      <div className="flex items-center justify-between lg:grid lg:grid-cols-3 lg:gap-8">
        ...
        <div className="flex justify-center">
          <h1 className="text-white text-2xl sm:text-3xl lg:text-4xl font-bold tracking-wider">
            BOOKET
          </h1>
        </div>
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 right-0 z-10 bg-transparent border-b border-white/20">
        <HeaderContent />
      </div>
      <div
